 ...
 try { 
   ...
   if (!fetched_user) return message.reply("User does not exist in the Database, Are you sure you got the Username right?")
    ...
    let embed = new MessageEmbed()
      ...
      .addField("Call Sign", `${fetched_user.user.callSign} || "Not Set"`, true)
      .addField("Active Community(s)", `${fetched_user.user.activeCommunity} || "none"`, true) 
      .addField("Dispatch Status", `${fetched_user.user.dispatchStatus} || "null"`, true)
      .addField("Status Set By", `${fetched_user.user.dispatchStatusSetBy} || "null"`, true) 
      .addField("Dispatch On Duty", `${fetched_user.user.dispatchOnDuty} || "null"`, true)
      .addField("Panic Sound Enabled", `${fetched_user.user.panicButtonSound} || "null"`, true) 
      .addField("Account Created", `${fetched_user.user.createdAt} || "null"`, true)
      .addField("Last Updated", `${fetched_user.user.updatedAt} || "null"`, true) 
